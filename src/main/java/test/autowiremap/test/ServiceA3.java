...
@Service
public class ServiceA3 implements InitializingBean {
    ...
    @Autowired
    public void factoryGroupsA(@Qualifier("factoryGroupsA") Map<String, Map<String, MyServiceFactory>> factoryGroupsA) {
